...
export function GradientArrow() {
  ...
  return (
    <motion.div
      className="absolute -left-10 top-0 flex h-full items-center justify-center"
    ...
    >
      ...
      >
        ...
        <defs>
          ...
          >
            <stop offset="0.0515742" stopColor="#4e46e533" stopOpacity="0" />
            <stop offset="0.225992" stopColor={activeColor} />
            <stop offset="0.47249" stopColor={activeColor} />
            <stop offset="0.522324" stopColor="#4e46e533" />
            <stop offset="0.561417" stopColor={activeColor} />
            <stop offset="0.791714" stopColor={activeColor} />
            <stop offset="0.956186" stopColor="#4e46e533" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </motion.div>
